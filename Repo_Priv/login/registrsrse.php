	...
	<body class="datos">
        ...
        <?php
          ...
          if (isset($_GET["error"])){
            ...
            if ($_GET["error"] == "other") {
              echo "<h4 style='color:red'>Error en la inscripción</h4>";
            }
        ...
        ?>
          ...
          <input class="controlador" type="hidden" name="table" value="usuarios" />
          <input class="controlador" type="hidden" name="act" value="new" />
          ...
          <h4>Repite contraseña</h4>
            <input class="controlador" type="password" name="rpassword" placeholder='Repetir Contraseña'/>
          
          <h4>Email</h4>
            <input class="controlador" type="email" name="correo" placeholder='Email'/>

          <h4>Localidad</h4>
            <input class="controlador" type="text" name="localidad" placeholder='Localidad'/>

          <h4>TIPO</h4>
            <select name="tipo" aria-describedby="searchDropdownDescription" class="select1" name="tipo">
          ...
          <div class="options">
            ...
            <input class="boton" type="submit" name="act" value="new"/>
