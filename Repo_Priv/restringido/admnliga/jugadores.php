...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div class="options">
            <ul>
                <li><a href="./jugadoresins.php?act=new">New Player</a></li>
            </ul>
        </div>
        ...
        <?php
            ...
            if ( $total < ((6 * $pax) +6)) {
                ...
                for ($i = (6 * $pax) ; $i < $total; $i++) {
                    ...
                    echo "<a href='./jugadoresins.php?act=mod&id=" .$filtrado[$i]["id"]. "'><img src='../../img/editar.png'/></a>";
            ...
            $paxante = $pax - 1;
                ...
                if ($pax == 0 && ($pax * 6) + 6 < $total){
                    ...
                    <div class='pasar'>
                        <p>
                            <a href='./jugadores.php?pax=$paxd'>Pág Siguiente</a>
                        </p>
                    </div>";
                    ...
                    <div class='pasar'>
                        <p>
                            <a href='./jugadores.php?pax=$paxante'>Pág anterior</a>
                        </p>
                    </div>";
                } elseif ($pax == 0 && ($pax * 6) + 6 > $total){
                    echo"
