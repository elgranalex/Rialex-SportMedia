...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
                ...
                if (isset($_GET["jornada"]) && $_GET["jornada"] <= 20 && 0 <= $_GET["jornada"] ) {
                    ...
                    foreach ($partidos as $partido) {
                        ...
                        if ($partido["jornada"] == $jornada) {
                            ...
                            $text = "<tr>
                                <td class='equipo1'>
                                    <a href='partidosins.php?act=mod&id=" .$partido["cod"]. "'><img style='padding-right:30px' src='../../img/editar.png'/></a>
                                    " .$nlocal. "
                                    <img src='../../" .$flocal. "'>
                                </td>
       ...
       <div class='options'>
            <ul>
                <li><a href='./partidosins.php?act=new&jornada=$jornada'>New Partido</a></li>
            </ul>
        </div>
        ";
