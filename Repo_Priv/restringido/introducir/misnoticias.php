...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div class="options">
            <ul>
                <li><a href="./noticiains.php?act=new">Crear Noticia</a></li>
            </ul>
        </div>
        ...
        <?php
                ...
                if ( $total < ((6 * $pax) +6)) {
                    ...
                    for ($i = (6 * $pax) ; $i < $total; $i++) {
                        ...
                        $texto = "<div class='content'>
                                    ...
                                    <a href='../../noticias/noticiasext.php?id=" .$filtrado[$i]["id"]. "'><p>Leer más</p></a>
                                </div>";
                        ...
                        echo "<div class='iconitos'>
                                <a href='./noticiains.php?act=mod&id=" .$filtrado[$i]["id"]. "'><img src='../../img/editar.png'/></a>
                            </div>";
                    ...
                    for ($i = (6 * $pax); $i < $ultimo; $i++) {
                        ...
                        $texto = "<div class='content'>
                                    ...
                                    <p>Hecho por : " .$filtrado[$i]["nombre"]. "</p>
                                    <p>Publicada en : " .$filtrado[$i]["fecha"]. "</p>
                                    <a href='../../noticias/noticiasext.php?id=$idnoti'><p>Leer más</p></a>
                                </div>";
            ...
            $paxd = $pax + 1;
                ...
                if ($pax == 0 && ($pax * 6) + 6 < $total){
                    ...
                    <div class='pasar'>
                        <p>
                            <a href='./misnoticias.php?pax=$paxd&cadena=$cadena&filtro1=$filtro1&filtro2=$filtro2&filtro3=$filtro3&ordenar=$orden'>Pág Siguiente</a>
                        </p>
                    </div>";
                    ...
                    <div class='pasar'>
                        <p>
                            <a href='./misnoticias.php?pax=$paxante&cadena=$cadena&filtro1=$filtro1&filtro2=$filtro2&filtro3=$filtro3&ordenar=$orden'>Pág anterior</a>
                        </p>
                    </div>";
                } elseif ($pax == 0 && ($pax * 6) + 6 >= $total){
                    echo"
