                    ...
                    foreach ($jugadores as $jugador) {
                        ...
                        if ($jugador["id"] == $gol["n_licencia_j"]){
                            ...
                            if ($local == $jugador["equipo_actual"]) {
                                $text = "<tr>
                                        <td class ='jugador1'>$foto" .$jugador["nombre_j"]. "</td>
                                ...
                                $text = "<tr>
                                        ...
                                        <td class='tiempo'>" .$gol["minuto"]. "'</td>
                                        <td class ='jugador2'>" .$jugador["nombre_j"]. "$foto</td>
                                    </tr>";
                                echo $text;
                            } 
                ...
                if ($id == $tarjeta["cod_partido"]) {
                    ...
                    foreach ($jugadores as $jugador) {
                        ...
                        if ($jugador["id"] == $tarjeta["n_licencia_j"]){
                            ...
                            if ($local == $jugador["equipo_actual"]) {
                                $text = "<tr>
                                        <td class ='jugador1'>$foto" .$jugador["nombre_j"]. "<img src='$color'></td>
                                ...
                                $text = "<tr>
                                        <td class ='jugador1'></td>
                                        <td class='tiempo'>" .$tarjeta["minuto"]. "'</td>
                                        <td class ='jugador2'><img src='$color'>" .$jugador["nombre_j"]. "$foto</td>
                                    </tr>";
                                echo $text;
                            } 
