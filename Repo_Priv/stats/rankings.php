...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div class="options">
            <ul>
                <li><a href="rankings.php?info=goleadores">GOLEADORES</a></li>
                <li><a href="rankings.php?info=asist">ASISTENTES</a></li>
            </ul>
        </div>

        <?php

        if (isset($_GET["info"]) && $_GET["info"] == "goleadores" ) {
            
            echo "

            <div class='wrap' id='goleadores'>
                <h1>GOLEADORES</h1>
            </div>
            ...
            ";
                ...
                $pos = 1;
                foreach ($goleadores as $cadauno) {
                    echo "<tr> 
                            <td>$pos</td> 
                            <td>" .$cadauno["nombre_j"]. "</td> 
                            <td>" .$cadauno["nombre_e"]. "</td>
                            <td>" .$cadauno["goles"]. "</td> 
                        </tr>";
                    $pos++;
                }
        ...
        } elseif (isset($_GET["info"]) && $_GET["info"] == "asist" ) {
