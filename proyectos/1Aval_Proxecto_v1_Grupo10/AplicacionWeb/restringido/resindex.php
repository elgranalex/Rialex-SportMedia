...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div class="options">
            <ul>
                <li><a href="./introducir/misproductos.php">Mis Productos</a></li>
                <li><a href="./introducir/jugadores.php">Jugadores</a></li>
                <li><a href="./introducir/tarjetas.php">Tarjetas</a></li>
                <li><a href="./introducir/partidos.php">Partidos</a></li>
                <li><a href="./introducir/misnoticias.php">Mis Noticias</a></li>
                <li><a href="./introducir/Sanciones.php">Sanciones</a></li>
            </ul>
        </div>
