...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div class="wrap">
            <h1>Términos y condiciones</hi>
        </div>

        <div class="cuerpo">
            <p>(Nombre de la tienda) Política de Términos y Condiciones
Bienvenido a (Nombre de la tienda). Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web (Nombre de la tienda).

(Nombre de la tienda) se encuentra en (Dirección).
