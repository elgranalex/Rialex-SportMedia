...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="datos">
        ...
        <form>
            ...
            <input class="controlador" type="text" name="autor" id="autor" placeholder="Ingrese el Nombre del jugador"/>
            <input class="controlador" type="text" name="autor" id="autor" placeholder="Minuto"/>
            <input class="controlador" type="text" name="autor" id="autor" placeholder="Partido"/>
            <select aria-describedby="searchDropdownDescription" class="select1" id="searchDropdownBox" name="url" title="Tipo de tarjeta">
                <option value="search-alias=jornada1" style="background-color: yellow">Amarilla</option>
                <option value="search-alias=jornada2"style="background-color: red">Roja</option>
            </select>
