...
CREATE TABLE `lesiones` (
  ...
  PRIMARY KEY (`n_licencia_j`,`fecha`),
  CONSTRAINT `lesiones_ibfk_1` FOREIGN KEY (`n_licencia_j`) REFERENCES `jugadores` (`n_licencia_j`)
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `lesion` AFTER INSERT ON `lesiones` FOR EACH ROW begin
		update jugadores
