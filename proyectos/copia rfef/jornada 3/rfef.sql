...
INSERT INTO `usuarios` (`nombre`, `localidad`, `correo`, `password`,`tipo`) VALUES
('Alex','Vigo', 'ale@hola.org', 'abc123.', "normal" ),
('Carlos','Vigo', 'carlos@hola.org', 'abc123.', "admin" ),
('Victor','Vigo', 'victor@hola.org', 'abc123.', "periodista" ),
('Raul','Vigo', 'Raul@hola.org', 'abc123.', "vendedor" );
...
INSERT INTO `productos` (`titulo`, `precio`, `descripcion`, `IdUsuario`) VALUES
('SuperCoche', 200, "El mejor coche",1),
('Marioneta', 300, "Marioneta",2);
...
CREATE TABLE `noticias` (
  `IdNoticia` int  PRIMARY KEY NOT NULL  AUTO_INCREMENT,
...
INSERT INTO `noticias` (`titulo`, `cuerpo`, `resumen`, `IdUsuario`) VALUES
('SuperCoche', 'ourhfvñoue', "El mejor coche", 1),
('Marioneta', 'ihsadbcvlsaidhcbal', "Marioneta", 2);
