...
CREATE TABLE `sanciones` (
  ...
  PRIMARY KEY (`n_licencia_j`,`cod_partido`),
  KEY `cod_partido` (`cod_partido`),
  CONSTRAINT `sanciones_ibfk_1` FOREIGN KEY (`n_licencia_j`) REFERENCES `jugadores` (`n_licencia_j`),
  CONSTRAINT `sanciones_ibfk_2` FOREIGN KEY (`cod_partido`) REFERENCES `partidos` (`cod`)
...
INSERT INTO `sanciones` VALUES (57,4,1),(171,10,1),(358,6,1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sancion` AFTER INSERT ON `sanciones` FOR EACH ROW begin
		update jugadores
